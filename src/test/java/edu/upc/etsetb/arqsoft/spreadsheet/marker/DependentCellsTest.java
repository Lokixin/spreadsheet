...
public class DependentCellsTest extends SuperClassForTests {
    ...
    public DependentCellsTest() throws UnknownFactoryException {
        super();
        numInstances++;
        if (numInstances == 1) {
    ...
    public static void tearDownClass() {
        showErrors(SuperClassForTests.indErrors, "DependentCellsTest", numErrorsBefore);
    ...
    public void test_03_DependentCellReferencedAsFunctionRangeArgument() throws Exception {
        ...
        try {
            ...
            error = this.sAssertEquals(43, content, 0.00001, valorTotal * 0.25, "The cell "
