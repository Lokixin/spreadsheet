...
public class TextContentTest extends SuperClassForTests {
    ...
    public TextContentTest() throws UnknownFactoryException {
        super();
        numInstances++;
        if (numInstances == 1) {
    ...
    public static void tearDownClass() {
        showErrors(indErrors, "TextContentTest", numErrorsBefore);
    ...
    public void testSetCellContent_TextContent() throws Exception {
        ...
        this.printlnAlways("\nSpreadsheetControllerForChecker::"
                + "testSetCellContent() with text content. Values: " + valorTotal);
        try {
